...
(lib.maskWithSound6 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(2).call(this.frame_2).wait(18).call(this.frame_20).wait(18).call(this.frame_38).wait(21).call(this.frame_59).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Bitmap2.png?1521965638703", id:"Bitmap2"}
	],
	preloads: []
};
